/*
registration number is always 9 characters long,
subject code is either CSE1001/CSE1002,
proctor ID is 4 characters long,
...
//This prints out all the available options in the DB
	...
	for (int i = 0;i < n;i++){   
		...
		cout << "Enter your registration number:(9 characters allowed) ";
		cin >> data;
		outfile << data << "\t";                         //@
		...
		outfile << empty << "\t";                        //@
		outfile << empty << "\t";                        //@
		cout << "Enter your proctor ID:(4 character allowed) ";
		cin >> proctor;
